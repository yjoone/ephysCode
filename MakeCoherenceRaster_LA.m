function [coherenceStruct,S1Struct,S2Struct,rasterWindowTimesSamplesStruct,fSpectOut] = MakeCoherenceRaster_LA(dam,startLastRangeSamples,chanNameCell1,chanNameCell2,dataAcq,varargin)
