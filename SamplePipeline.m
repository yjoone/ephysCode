...
chronuxDataStructure1Use = chronuxDataStruct_Neil_NAcc_Matched;
chronuxDataStructure2Use = chronuxDataStruct_Neil_PFC_Matched;
...
coherogramStructNoMeanSTD = ChronuxMultitaperFunctionsAcrossBehaviorsNL({chronuxDataStructure1Use},{chronuxDataStructure2Use},paramsStruct,'typeFunction','coherogram','movingwinStruct',movingwinStruct);
coherogramStructNoBiasCorrectionNoTransformNoMeanSTD = ChronuxMultitaperFunctionsAcrossBehaviorsNL({chronuxDataStructure1Use},{chronuxDataStructure2Use},paramsStruct,'typeFunction','coherogram','movingwinStruct',movingwinStruct,'biasCorrectAndTransform','off');

%% Step 14: Add means and stds to coherogram structures

coherogramStruct = coherogramStructNoMeanSTD;
coherogramStructNoBiasCorrectionNoTransform = coherogramStructNoBiasCorrectionNoTransformNoMeanSTD;

behavNamesCoherogramStruct = fieldnames(coherogramStructNoMeanSTD);
...
for i=1:numel(behavNamesCoherogramStruct)
    ...
    CValsCoherogram = coherogramStructNoMeanSTD.(behavNameCoherogramStruct).C;
    ...
    phiValsCoherogram = coherogramStructNoMeanSTD.(behavNameCoherogramStruct).phi;
    ...
    S12ValsCoherogram = coherogramStructNoMeanSTD.(behavNameCoherogramStruct).S12;
    ...
    S1ValsCoherogram = coherogramStructNoMeanSTD.(behavNameCoherogramStruct).S1;
    ...
    S2ValsCoherogram = coherogramStructNoMeanSTD.(behavNameCoherogramStruct).S2;
    ...
    phistdValsCoherogram = coherogramStructNoMeanSTD.(behavNameCoherogramStruct).phistd;
